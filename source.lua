...
local Library = {
	...
	AccentColor = Color3.fromRGB(135, 0, 255);
		...
		do
			...
			function ContextMenu:AddOption(Str, Callback)
				...
				Button.InputBegan:Connect(function(Input)
					if Input.UserInputType ~= Enum.UserInputType.MouseButton1 and Input.UserInputType ~= Enum.UserInputType.Touch and Input.UserInputType ~= Enum.UserInputType.Gamepad1 then
						return
					end
		...
		function KeyPicker:GetState()
			...
			elseif KeyPicker.Mode == 'Hold' then
				...
				if Key == 'MB1' or Key == 'MB2' then
					return Key == 'MB1' and (InputService:IsMouseButtonPressed(Enum.UserInputType.MouseButton1) or InputService:IsTouchDevice())
						or Key == 'MB2' and (InputService:IsMouseButtonPressed(Enum.UserInputType.MouseButton2) or InputService:IsTouchDevice());
				else
	...
	function Funcs:AddDropdown(Idx, Info)
		...
		function Dropdown:SetValues()
			...
			for Idx, Value in next, Values do
				...
				-- Transparent "touch catcher" to avoid blocking scrolling
		...
		function Dropdown:SetValue(Val)
			if Dropdown.Multi then
				...
				if not table.find(Dropdown.Values, Val) then
					return;
				end;
